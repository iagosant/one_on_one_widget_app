...
class WidgetFormsControllerTest < ActionController::TestCase
  ...
  test "should create widget_form" do
    assert_difference('WidgetForm.count') do
      post :create, widget_form: { background_color: @widget_form.background_color, title_text: @widget_form.title_text, user_id: @widget_form.user_id }
    end
  ...
  test "should update widget_form" do
    patch :update, id: @widget_form, widget_form: { background_color: @widget_form.background_color, title_text: @widget_form.title_text, user_id: @widget_form.user_id }
    assert_redirected_to widget_form_path(assigns(:widget_form))
  end
